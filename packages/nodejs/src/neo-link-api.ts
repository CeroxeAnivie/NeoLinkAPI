...
export class NeoLinkAPI {
  ...
  getHookSocket(): SecureSocket | null { return this.hookSocket; }
  getUpdateURL(): string | null { return this.updateUrl; }
  getState(): NeoLinkState { return this.state; }

  setOnStateChanged(handler: (state: NeoLinkState) => void): this { this.onStateChanged = handler; return this; }
  setOnError(handler: (message: string, cause: unknown) => void): this { this.onError = handler; return this; }
  setOnServerMessage(handler: (message: string) => void): this { this.onServerMessage = handler; return this; }
  setUnsupportedVersionDecision(handler: (response: string) => boolean | Promise<boolean>): this { this.unsupportedVersionDecision = handler; return this; }
  setDebugSink(handler: DebugSink): this { this.debugSink = handler; return this; }
  setOnConnect(handler: ConnectionEventHandler): this { this.onConnect = handler; return this; }
  setOnDisconnect(handler: ConnectionEventHandler): this { this.onDisconnect = handler; return this; }
  setOnConnectNeoFailure(handler: () => void): this { this.onConnectNeoFailure = handler; return this; }
  setOnConnectLocalFailure(handler: () => void): this { this.onConnectLocalFailure = handler; return this; }
