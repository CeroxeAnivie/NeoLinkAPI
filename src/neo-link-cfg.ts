...
export class NeoLinkCfg {
    ...
    getRemoteDomainName(): string {
        return this.remoteDomainName;
    }

    setRemoteDomainName(value: string): this {
        this.remoteDomainName = requireText(value, 'remoteDomainName');
        return this;
    }
    ...
    setHookPort(value: number): this {
        this.hookPort = requirePort(value, 'hookPort');
        return this;
    }

    getHostConnectPort(): number {
        return this.hostConnectPort;
    }

    setHostConnectPort(value: number): this {
        this.hostConnectPort = requirePort(value, 'hostConnectPort');
        return this;
    }

    getLocalDomainName(): string {
        return this.localDomainName;
    }

    setLocalDomainName(value: string): this {
        this.localDomainName = requireText(value, 'localDomainName');
        return this;
    }
    ...
    setLocalPort(value: number): this {
        this.localPort = requirePort(value, 'localPort');
        return this;
    }
    ...
    setKey(value: string): this {
        this.key = requireText(value, 'key');
        return this;
    }

    getProxyIPToLocalServer(): string {
        return this.proxyIPToLocalServer;
    }

    setProxyIPToLocalServer(value: string = DEFAULT_PROXY_IP): this {
        this.proxyIPToLocalServer = nullToEmpty(value);
        return this;
    }

    getProxyIPToNeoServer(): string {
        return this.proxyIPToNeoServer;
    }

    setProxyIPToNeoServer(value: string = DEFAULT_PROXY_IP): this {
        this.proxyIPToNeoServer = nullToEmpty(value);
        return this;
    }

    getHeartBeatPacketDelay(): number {
        return this.heartBeatPacketDelay;
    }

    setHeartBeatPacketDelay(value: number): this {
        this.heartBeatPacketDelay = requirePositive(value, 'heartBeatPacketDelay');
        return this;
    }
    ...
    setTCPEnabled(value: boolean): this {
        this.tcpEnabled = Boolean(value);
        return this;
    }
    ...
    setUDPEnabled(value: boolean): this {
        this.udpEnabled = Boolean(value);
        return this;
    }

    isPPV2Enabled(): boolean {
        return this.ppv2Enabled;
    }

    setPPV2Enabled(value = true): this {
        this.ppv2Enabled = Boolean(value);
        return this;
    }
    ...
    setClientVersion(value: string): this {
        this.clientVersion = requireText(value, 'clientVersion');
        return this;
    }
    ...
    setDebugMsg(value = true): this {
        this.debugMsg = Boolean(value);
        return this;
    }
}
