...
replaceInFile(
  'packages/java/src/test/java/top/ceroxe/api/neolink/HandshakeProtocolMirrorTest.java',
  /不受支持的版本，应该为:[0-9.]+/,
  `不受支持的版本，应该为:${apiVersion}`
);

replaceInFile(
  'packages/java/src/test/java/top/ceroxe/api/neolink/NeoLinkCfgTest.java',
